...
export const DEFAULT_TERRAIN_TYPES = [
  ...
  { id: 'road', name: 'Cesta', blocksLOS: false, roadMovementBonus: 1, diceModifierDefenseInfantry: 0, diceModifierDefenseTank: 0, diceModifierAttackInfantry: 0, diceModifierAttackTank: 0, color: '#d2b98a', description: 'Jednotka, která začne pohyb na cestě, jede jen po ní a skončí na ní, má pohyb +1. Neomezuje viditelnost.' },
  { id: 'ford', name: 'Brod', blocksLOS: false, movementRestriction: 'stop' as const, allowAttackAfterStop: true, diceModifierDefenseInfantry: 0, diceModifierDefenseTank: 0, diceModifierAttackInfantry: -1, diceModifierAttackTank: -1, diceModifierAttackArtillery: -1, color: '#8fb8d0', description: 'Brodící se řeka: jednotka po vstupu zastaví a dál nejede, může ale útočit. Útok z brodu: -1 kostka. Neblokuje viditelnost.' },
  { id: 'mountain', name: 'Hory', blocksLOS: true, highGround: true, movementRestriction: 'stop' as const, impassableForCategories: ['tank', 'artillery'] as any, diceModifierDefenseInfantry: 2, diceModifierDefenseTank: 2, diceModifierAttackInfantry: 0, diceModifierAttackTank: 0, color: '#8d8071', description: 'Vyšší a hůř prostupné než kopce: projde jen pěchota a po vstupu zastaví. Při útoku na jednotku v horách: -2 kostky; na společném hřebenu postih neplatí a jednotky na sebe vidí. Blokuje viditelnost.' },
  { id: 'sea', name: 'Moře', blocksLOS: false, exitToAdjacentOnly: true, cannotAttackFrom: true, noRetreatInto: true, noRetreatCategories: ['infantry', 'tank', 'artillery'] as any, diceModifierDefenseInfantry: 0, diceModifierDefenseTank: 0, diceModifierAttackInfantry: 0, diceModifierAttackTank: 0, color: '#4d7f9e', description: 'Jednotka začínající na moři se pohne nejvýše o 1 pole. Z moře nelze útočit. Na moře ani po moři se nesmí ustupovat – vlajky se mění ve ztráty. Neblokuje viditelnost.' },
  { id: 'beach', name: 'Pláž', blocksLOS: false, movementCap: 2, diceModifierDefenseInfantry: 0, diceModifierDefenseTank: 0, diceModifierAttackInfantry: 0, diceModifierAttackTank: 0, color: '#e6d7a3', description: 'Pohyb jednotky, jejíž trasa vede přes pláž, je omezen nejvýše na 2 pole, i kdyby jednotka mohla jet dál. Neblokuje viditelnost.' }
];
